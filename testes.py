...
#de partida encerrada de marca_pontuacao.
    ...
    def test_070_encerra_partida_nok_sem_partida(self):
    ...
    def test_073_inicia_partida_ok(self):
    ...
    def test_074_inicia_partida_nok_partida_em_andamento(self):
        print("Caso de Teste 074 - Inicia partida recusa iniciar partida"+
    ...
    def test_077_marca_pontuacao_nok_jogador_do_turno_nao_lancou(self):
        print("Caso de Teste 077 - Erro ao marcar pontuacao sem lancar"+
                " dados no turno.")
        retorno = partida.marca_pontuacao('2')
        self.assertEqual( retorno, 3 )

    def test_078_faz_lancamento_ok(self):
        print("Caso de Teste 078 - Faz lancamento em partida com sucesso.")
        retorno = partida.faz_lancamento([])
        self.assertEqual(retorno, 0)

    def test_079_faz_lancamento_ok_reduziu_tentativas(self):
        print("Caso de Teste 079 - Faz lancamento reduz o numero de"+
                " tentativas.")
        info = partida.obtem_info_partida()
        self.assertEqual( info['tentativas'], 2 )

    def test_080_faz_lancamento_nok_tentativas_esgotadas(self):
        print("Caso de Teste 080 - Faz lancamento erro quando o jogador já"+
    ...
    def test_081_faz_lancamento_ok_combinacao_gerada_com_sucesso(self):
        print("Caso de Teste 081 - Faz lancamento combinação gerada.")
        info = partida.obtem_info_partida()
    ...
    def test_084_marca_pontuacao_ok_passou_o_turno(self):
        print("Caso de Teste 084 - Marca pontuacao passou o turno.")
        retorno = partida.obtem_info_partida()['turno']
        self.assertEqual( retorno, 2 )

    def test_085_marca_pontuacao_ok_restaura_tentativa(self):
        print("Caso de Teste 085 - Marca pontuacao proximo jogador tem 3"+
                " tentativas.")
        info = partida.obtem_info_partida()['tentativas']
        self.assertEqual( info, 3 )

    def test_086_desiste_ok_condicao_retorno(self):
        print("Caso de Teste 086 - Desiste com sucesso.")
        retorno = partida.desiste('julia')
        self.assertEqual( retorno, 0 )

    def test_087_desiste_ok_retira_jogador(self):
        print("Caso de Teste 087 - Desiste retira jogador da partida.")
        jogadores = partida.obtem_info_partida()['jogadores']
        self.assertNotIn( 'julia', jogadores )

    def test_088_desiste_nok_nome_invalido(self):
        print("Caso de Teste 088 - Erro desiste jogador invalido.")
        retorno = partida.desiste('julia')
        self.assertEqual( retorno, 2 )

    def test_089_marca_pontuacao_nok_jogador_ja_marcou_na_categoria(self):
    ...
    def test_090_salva_partida_ok_condicao_retorno(self):
        print("Caso de Teste 090 - Salva partida sucesso.")
        dir_raiz = path.dirname(path.realpath(__file__))
        saves = path.join(dir_raiz, 'saves') 
        retorno = partida.salva_partida(saves)
        self.assertEqual(retorno, 0)

    def test_091_salva_partida_nok_path_invalido(self):
        print("Caso de Teste 091 - Erro salva_partida caminho não encontrado")
        dir_raiz = path.dirname(path.realpath(__file__))
        saves = path.join(dir_raiz, 'pasta_nao_existente') 
        retorno = partida.salva_partida(saves)
        self.assertEqual(retorno, 2)

    def test_092_encerra_partida_ok_condicao_retorno(self):
        print("Caso de Teste 092 - Encerra partida com sucesso.")
        retorno = partida.encerra_partida()
        self.assertEqual( retorno, 0 )
    ...
    def test_094_continua_partida_nok_arquivo_inexistente(self):
        print("Caso de Teste 094 - Continua partida Erro ao não encontrar o arquivo")
